...
#SBATCH --mem=100GB
#SBATCH --output=out.vgg16_600_8_0.01_k80_full.%j
...
echo "vgg16_600_8_0.01_k80_full"
...
nvprof --timeout 600 --csv --print-summary python main.py --arch vgg16 -b 8 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
# nvprof --timeout 300 --output-profile vgg16_4_0.01_k80_conv_%p.nvvp --kernels "convolve" --metrics gld_efficiency --csv --print-summary python main.py --arch vgg16 -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
