...
#SBATCH --mem=100GB
#SBATCH --output=out.vgg16_4_0.01_%GPU%_full.%j
...
echo "vgg16_4_0.01_%GPU%_full"
nvprof --timeout 300 --output-profile vgg16_4_0.01_%GPU%_full_%p.nvvp --csv --print-summary python main.py --arch vgg16 -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
...
# nvprof --timeout 300 --output-profile vgg16_64_0.01_%GPU%_full_%p_mem.nvvp --csv --track-memory-allocations on --print-summary python main.py --arch vgg16 -b 64 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
