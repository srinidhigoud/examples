...
#SBATCH --mem=100GB
#SBATCH --output=out.resnet18_16_0.01_k80_loss_only.%j
...
echo "resnet18_16_0.01_k80_loss_only"
nvprof --timeout 300 --csv --profile-from-start off --print-summary python subsectionMain.py --arch resnet18 -b 16 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
