...
#SBATCH --mem=100GB
#SBATCH --output=out.alexnet_4_0.01_k80_loss_only.%j
...
echo "alexnet_4_0.01_k80_loss_only"
nvprof --timeout 300 --csv --profile-from-start off --print-summary python subsectionMain.py --arch alexnet -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
