...
#SBATCH --mem=100GB
#SBATCH --output=out.vgg16_8_0.01_k80_loss_only.%j
...
echo "vgg16_8_0.01_k80_loss_only"
nvprof --timeout 300 --csv --profile-from-start off --print-summary python subsectionMain.py --arch vgg16 -b 8 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
