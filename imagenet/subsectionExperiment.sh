...
#SBATCH --mem=100GB
#SBATCH --output=out.alexnet_16_0.01_%GPU%_loss_only.%j
...
echo "alexnet_16_0.01_%GPU%_loss_only"
nvprof --timeout 100 --csv --profile-from-start off --print-summary python subsectionMain.py --arch alexnet -b 16 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
...
# nvprof --timeout 1800 --output-profile alexnet_loss_only_16_0.001_small_%GPU%_%p.nvvp --csv --log-file alexnet_loss_only_16_0.001_small_%GPU%_%p.log --profile-from-start off --track-memory-allocations on --cpu-profiling on --print-summary python subsectionMain.py --arch alexnet -b 16 --epochs 1 --lr 0.001 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small


# source ~/pytorch_env/py3.6.3/bin/activate
# echo "alexnet_16_0.001_%GPU%_loss_only"
# nvprof --timeout 1800 --output-profile alexnet_loss_only_16_0.001_small_%GPU%_%p.nvvp --csv --log-file alexnet_loss_only_16_0.001_small_%GPU%_%p.log --profile-from-start off --track-memory-allocations on --cpu-profiling on --print-summary python subsectionMain.py --arch alexnet -b 16 --epochs 1 --lr 0.001 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
# # nvprof --output-profile alexnet_loss_only_16_0.001_small_%GPU%_%p.nvvp --csv --log-file alexnet_loss_only_16_0.001_small_%GPU%_%p.log --profile-from-start off --track-memory-allocations on --cpu-profiling on --print-summary python subsectionMain.py --arch alexnet -b 16 --epochs 1 --lr 0.001 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
