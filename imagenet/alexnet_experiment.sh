...
#SBATCH --mem=100GB
#SBATCH --output=out.alexnet_600_8_0.01_k80_full.%j
...
echo "alexnet_600_8_0.01_k80_full"
...
nvprof --timeout 600 --csv --print-summary python main.py --arch alexnet -b 8 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
# nvprof --timeout 300 --output-profile alexnet_4_0.01_k80_conv_%p.nvvp --kernels "convolve" --metrics gld_efficiency --csv --print-summary python main.py --arch alexnet -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
