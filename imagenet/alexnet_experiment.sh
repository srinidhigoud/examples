...
#SBATCH --mem=100GB
#SBATCH --output=out.alexnet_4_0.01_%GPU%_full.%j
...
nvprof --timeout 300 --output-profile alexnet_4_0.01_%GPU%_full_%p.nvvp --csv --print-summary python main.py --arch alexnet -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
