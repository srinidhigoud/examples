...
#SBATCH --mem=100GB
#SBATCH --output=out.alexnet_4_0.01_"$1"_full.%j
...
echo "alexnet_4_0.01_"$1"_full"
nvprof --timeout 300 --output-profile alexnet_4_0.01_"$1"_full_%p.nvvp --csv --print-summary python main.py --arch alexnet -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
...
# nvprof --timeout 300 --output-profile alexnet_64_0.01_"$1"_full_%p_mem.nvvp --csv --track-memory-allocations on --print-summary python main.py --arch alexnet -b 64 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
...
# nvprof --timeout 1800 --output-profile alexnet_16_0.001_small_"$1"_timeout_%p.nvvp --csv --log-file alexnet_16_0.001_small_"$1"_timeout_%p.log --track-memory-allocations on --cpu-profiling on --print-summary python main.py --arch alexnet -b 16 --epochs 1 --lr 0.001 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small


# echo "alexnet_16_0.001_"$1"_full"
# nvprof --timeout 1800 --output-profile alexnet_16_0.001_small_"$1"_timeout_%p.nvvp --csv --log-file alexnet_16_0.001_small_"$1"_timeout_%p.log --track-memory-allocations on --cpu-profiling on --print-summary python main.py --arch alexnet -b 16 --epochs 1 --lr 0.001 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
# # nvprof --output-profile alexnet_16_0.001_small_"$1"_wotimeout_%p.nvvp --csv --log-file alexnet_16_0.001_small_"$1"_wotimeout_%p.log --track-memory-allocations on --cpu-profiling on --print-summary python main.py --arch alexnet -b 16 --epochs 1 --lr 0.001 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
