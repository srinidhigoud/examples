...
#SBATCH --mem=100GB
#SBATCH --output=out.resnet18_4_0.01_p40_full_mem.%j
...
echo "resnet18_4_0.01_p40_full_mem"
...
# nvprof --timeout 300 --output-profile resnet18_4_0.01_p40_full_%p_mem.nvvp --csv --track-memory-allocations on --print-summary python main.py --arch resnet18 -b 1 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
