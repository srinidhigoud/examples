...
#SBATCH --mem=100GB
#SBATCH --output=out.resnet18_4_0.01_k80_full.%j
...
echo "resnet18_4_0.01_k80_full"
nvprof --timeout 300 --output-profile resnet18_4_0.01_k80_full_%p.nvvp --csv --print-summary python main.py --arch resnet18 -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
...
# nvprof --timeout 300 --output-profile resnet18_64_0.01_k80_full_%p_mem.nvvp --csv --track-memory-allocations on --print-summary python main.py --arch resnet18 -b 64 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
