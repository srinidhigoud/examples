...
#SBATCH --mem=100GB
#SBATCH --output=out.resnet18_600_1_0.01_k80_full.%j
...
echo "resnet18_600_1_0.01_k80_full"
...
nvprof --timeout 600 --csv --print-summary python main.py --arch resnet18 -b 1 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
# nvprof --timeout 300 --output-profile resnet18_4_0.01_k80_conv_%p.nvvp --kernels "convolve" --metrics gld_efficiency --csv --print-summary python main.py --arch resnet18 -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
